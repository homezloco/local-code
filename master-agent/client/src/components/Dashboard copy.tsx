      ...
      <div className="min-h-screen bg-slate-950 text-slate-100">
        <header className="border-b border-slate-800 bg-slate-900/80 backdrop-blur">
          <div className="max-w-6xl mx-auto px-4 py-4 flex flex-wrap items-center gap-3">
            <div>
              <div className="text-lg font-semibold">Master Agent</div>
        ...
        <main className="max-w-6xl mx-auto px-4 py-6 space-y-6">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="border border-slate-800 rounded-xl bg-slate-900/60 p-4 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="border border-slate-800 rounded-xl bg-slate-900/60 p-4 shadow-lg">
              ...
              {renderWidget('templates')}
            </div>
            <div className="border border-slate-800 rounded-xl bg-slate-900/60 p-4 shadow-lg">
              <div className="flex items-center justify-between mb-3">
                <h2 className="text-lg font-semibold">Plan / Codegen</h2>
              </div>
              {renderWidget('result')}
            </div>
          </div>
